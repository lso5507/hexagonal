...
class BoardControllerTest {
    ...
    fun setUp() {
        ...
        val userCreateRequest = UserCreateRequest(name = "testUser", email = "test@example.com", password = "password")
    ...
    inner class UpdateBoardTests {
        ...
        fun `should return forbidden when another user tries to update board`() {
            val createdBoard = createTestBoard(testUser.id!!)
            userAdapter.saveUser(User(name = "anotherUser", email = "another@example.com", password = "password"))
    ...
    inner class DeleteBoardTests {
        ...
        @Test
        @WithMockUser(username = "another@example.com")
        @DisplayName("실패: 다른 사용자가 게시글 삭제 시도")
        fun `should return forbidden when another user tries to delete board`() {
            val createdBoard = createTestBoard(testUser.id!!)
            userAdapter.saveUser(User(name = "anotherUser", email = "another@example.com", password = "password"))
